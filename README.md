...
#### Option A: Using a Saved Schema ID
```json
POST /extract
{
...
#### Option B: Using Direct Fields Definition
```json
POST /extract
{
    "text": "New MacBook Pro 2024 (SKU: MB2024PRO) in Electronics category. Premium laptop priced at $1,999.99 USD.",
    "fields": [
        {
            "key": "product",
            "type": "object",
...
- When using `fields`, they follow the same structure rules as schema creation
- Text has a maximum length of 10,000 characters
- Valid OpenAI API key required

**Response Example for Option A:**
[Previous response example remains the same...]

**Response Example for Option B:**
```json
{
    "extracted_data": [
        {
